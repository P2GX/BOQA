...
//     *                 plain {@link DiagnosisData} used for scoring
//     */
...
//        this.diagnosisData = DiagnosisDataPhenolIngest.of(hpo, diseases);
...
//     *   {@link BoqaPatientAnalyzer.computeUnnormalizedLogProbability(AlgorithmParameters, BoqaCounts)}</li>
//     * </ol>
//     *
...
//    ) {
//        List<CandidateDiagnosis> candidateDiseaseList = CandidateDisease.createCandidateDiagnoses(targetDiseaseList, this.hpoDiseases);
