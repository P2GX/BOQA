 ...
 */
public class DiagnosisDataPhenolIngest implements DiagnosisData {
    private static final Logger LOGGER = LoggerFactory.getLogger(DiagnosisDataPhenolIngest.class);
    ...
    public static DiagnosisData of(Ontology hpo, HpoDiseases diseases) {
        return new DiagnosisDataPhenolIngest(hpo, diseases);
    }

    private DiagnosisDataPhenolIngest(Ontology hpo, HpoDiseases diseases){
        this.hpo = hpo;
     ...
     */
    public DiagnosisDataPhenolIngest(InputStream ontologyStream, InputStream annotationsStream) throws IOException {
     ...
     * @throws IOException if reading the streams fails
     */
    public DiagnosisDataPhenolIngest(InputStream annotationsStream,
