...
//            new TargetDisease.PhenotypeOnly("OMIM:154700", "Marfan syndrome", Set.of());
//    private static final TargetDisease MARFAN_GENE = new TargetDisease.PhenotypeAndGene(
//            "OMIM:154700", "Marfan syndrome", "2200", "FBN1", Set.of()); // what was the number 2200?
//    private static final TargetDisease GLUTARIC_ACIDURIA =
//            new TargetDisease.PhenotypeOnly("OMIM:231670", "Glutaric acidemia I", Set.of());
//    private static final TargetDisease GLUTARIC_ACIDURIA_GENE = new TargetDisease.PhenotypeAndGene(
//            "OMIM:231670", "Glutaric acidemia I", "2639", "GCDH",Set.of());
//
...
//        CandidateResult.BlendedResult result = new CandidateResult.BlendedResult(
...
//        assertThrows(IllegalArgumentException.class, () -> new CandidateResult.BlendedResult(
