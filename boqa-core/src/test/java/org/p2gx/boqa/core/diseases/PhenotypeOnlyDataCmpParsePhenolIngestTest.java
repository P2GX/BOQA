 ...
 */
class PhenotypeOnlyDataCmpParsePhenolIngestTest {
    ...
    static void setup() throws IOException {
        try (InputStream is = new GZIPInputStream(PhenotypeOnlyDataCmpParsePhenolIngestTest.class
        ...
        try (
            InputStream annotationStream = new GZIPInputStream(PhenotypeOnlyDataCmpParsePhenolIngestTest.class
                    .getResourceAsStream("/org/p2gx/boqa/core/phenotype.v2025-05-06.hpoa.gz"));
            InputStream ontologyStream = new GZIPInputStream(PhenotypeOnlyDataCmpParsePhenolIngestTest.class
