package com.github.p2gx.diboq.cli;
...
@CommandLine.Command(name = "diboq",
        header = "Phenotype-driven prioritization of diagnoses\n",
...
public class Main implements Callable<Integer> {
    ...
    public static final String VERSION = "diboq v0.1.0-SNAPSHOT";
